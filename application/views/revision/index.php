...
<div class="row">
	<div class="col-md-4 offset-md-1 text-center">
		<a href="<?=base_url('revision/trace')?>">
			<img src="<?=base_url('assets/images/calligraphy.jpg')?>" alt="Calligraphy" class="img-thumbnail" />	
	...
	<div class="col-md-4 offset-md-2 text-center">
		<a href="<?=base_url('revision/translate')?>">
			<img src="<?=base_url('assets/images/translate.png')?>" alt="Translate" class="img-thumbnail" />	
